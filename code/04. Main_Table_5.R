...
x_distbuf_1 = paste("log(price_real)  ~ rob_log_sd_inter_0_50 + rob_log_sd_inter_50_200 + 
                  rob_dist_0_50m + rob_dist_50_200m +",
                    paste0(x_struct, collapse=" + "))

x_distbuf_2 = paste("log(price_real)  ~ rob_log_sd_inter_0_100 + rob_log_sd_inter_100_200 + 
                  rob_dist_0_100m + rob_dist_100_200m +",
                    paste0(x_struct, collapse=" + "))

x_distbuf_3 = paste("log(price_real)  ~ rob_log_sd_inter_0_100 + rob_log_sd_inter_100_300 + 
                  rob_dist_0_100m + rob_dist_100_300m +",
                    paste0(x_struct, collapse=" + "))

x_distbuf_4 = paste("log(price_real)  ~ rob_log_sd_inter_0_200 + rob_log_sd_inter_200_500 + 
                  rob_dist_0_200m + rob_dist_200_500m +",
                    paste0(x_struct, collapse=" + "))

x_distbuf_5 = paste("log(price_real)  ~ rob_log_sd_inter_0_300 + rob_log_sd_inter_300_1000 + 
                  rob_dist_0_300m + rob_dist_300_1000m +",
                    paste0(x_struct, collapse=" + "))
...
models_fes = list(
  ...
  model_3 = feols(as.formula(paste(x_distbuf_3, fes_ward)), df_main, vcov = ~ward),
  model_4 = feols(as.formula(paste(x_distbuf_4, fes_ward)), df_main, vcov = ~ward),
  model_5 = feols(as.formula(paste(x_distbuf_5, fes_ward)), df_main, vcov = ~ward)
)
