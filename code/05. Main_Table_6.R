...
models_fes = list(
  ...
  model_2 = feols(as.formula(paste(x_distbuf_2, fes_ward)), df_house, vcov = ~ward),
  model_3 = feols(as.formula(paste(x_distbuf_2, fes_ward)), df_non_house, vcov = ~ward)
)
