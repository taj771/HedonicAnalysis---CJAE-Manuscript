...
models_fes = list(
  model_1 = feols(as.formula(paste(x_distbuf_2, fes_ward)), df_main, vcov = ~ward),
  model_2 = feols(as.formula(paste(x_distbuf_2, fes_ward)), df_cottage, vcov = ~ward),
  model_3 = feols(as.formula(paste(x_distbuf_2, fes_ward)), df_non_cottage, vcov = ~ward)
)
